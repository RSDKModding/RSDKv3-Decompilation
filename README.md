...
* Then run `make CXX=x86_64-w64-mingw32-g++ STATIC=1 -j4` (-j switch is optional but will make building faster, it's based on the number of cores you have +1 so 8 cores wold be -j9)
